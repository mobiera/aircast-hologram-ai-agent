...
@ApplicationScoped
public class LangchainProducer extends AbstractProducer<OllamaMsg> {
	...
	@ConfigProperty(name = "io.twentysixty.demos.auth.jms.langchain.producer.threads")
	Integer _threads;
	...
	private static final Logger logger = Logger.getLogger(LangchainProducer.class);
